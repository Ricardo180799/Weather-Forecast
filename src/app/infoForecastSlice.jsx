...
export const infoForecastSlice = createSlice({name:"infoF",initialState:{carga:{data:null,loading:false,error:null},objetivo:null,dia:""},
...
extraReducers: (builder)=>{
    ...
    .addCase(fetchF.fulfilled , (state,action)=>{state.carga.loading = false,state.carga.error = null,state.carga.data = action.payload})
